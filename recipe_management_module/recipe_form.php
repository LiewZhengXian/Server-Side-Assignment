...
<body>
    ...
    <div class="container mt-4 mb-4">
        <h2 class="mb-3"><?php echo $formTitle; ?></h2>
        <form id="recipeForm" method="POST" action="<?php echo $formAction; ?>">
            <div class="row mb-3">
                <div class="col-md-6">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="url" class="form-control" name="image_url" value="<?php echo htmlspecialchars($recipe['image_url'] ?? ''); ?>">
                </div>
            </div>
            <div class="mb-3">
                <label class="form-label">Description</label>
                <textarea class="form-control" name="description" rows="3" required><?php echo htmlspecialchars($recipe['description'] ?? ''); ?></textarea>
            </div>
            <div class="row mb-3">
                <div class="col-md-2">
                    <label class="form-label">Prep Time (minutes)</label>
                    <input type="number" class="form-control" name="prep_time" min="0" value="<?php echo htmlspecialchars($recipe['prep_time'] ?? ''); ?>" required>
                </div>
                <div class="col-md-2">
                    <label class="form-label">Cook Time (minutes)</label>
                    <input type="number" class="form-control" name="cook_time" min="0" value="<?php echo htmlspecialchars($recipe['cook_time'] ?? ''); ?>" required>
                </div>
                <div class="col-md-2">
                    <label class="form-label">Servings</label>
                    <input type="number" class="form-control" name="servings" min="0" value="<?php echo htmlspecialchars($recipe['servings'] ?? ''); ?>" required>
                </div>
                <div class="col-md-1">
